# Reranker we use two different reranker 
# 1. Colbert 
...
def train(args): # right now if use the plos or elife will directly using BioLinkBERT
    if args.dataset in ["medqa_usmle_hf","plos", "elife"]:
        args.data_dir = "data"
    ...
    if not args.no_report:
        wandb.init(project="KARD-reranker") # You can define any kinds of name here
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=str, default="plos_train")
    parser.add_argument("--data_dir", type=str, default="/data")
    parser.add_argument("--save_dir", type=str, default=f"colbert_lr1e-3_plos_train")
    parser.add_argument("--search_space_dir",type=str, default="./search_spaces")
    ...
    parser.add_argument("--no_report",type=bool, default=False)
    parser.add_argument("--tau_annealing", type=bool, default=True)
    parser.add_argument("--update_both", type=bool, default=True)
    parser.add_argument("--loss_type", type=str, default="ce")
    parser.add_argument("--generate_search_space", type=bool, default=True)
    parser.add_argument("--no_scheduler", type=bool, default=False)
    parser.add_argument("--alpha", type=float, default=1.0)
    parser.add_argument("--only_from_rationale", type=bool, default=False)
    parser.add_argument("--only_from_question", type=bool, default=False)
    parser.add_argument("--query_key", type=str, default="first_gen")
    parser.add_argument("--rational_key", type=str, default="ground_truth")
    parser.add_argument("--file_name", type=str, default="GT_firstGen_plos_train.json")
